...
abstract class QDebug
{
     ...
     * @param int $depth
     */
    static function dump($vars, $label = 'display:block;', $depth = null)
    {
        ...
        $file = str_replace(realpath(dirname($_SERVER['DOCUMENT_ROOT'])),'',$file);
        $line = $last['line'];

        $html = 1;//ini_get('html_errors');
        ...
        if ($html)
        {
            ...
            $content = <<<EOT
<div style="font-size: 12px; color: #333; background-color: #fff;font-family: 'Courier New', Courier, monospace;display:block;">
